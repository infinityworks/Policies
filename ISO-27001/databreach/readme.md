...
### Non-Infinity Works Originated Incidents

Where an individual becomes aware of a data breach or security incident on a client’s system involving a client’s data or information, they should report this to their Account Lead and should inform the client and work with the client in accordance with its data and information security policy.

### Infinity Works Originated Incidents

Any individual who accesses, uses or manages the company’s information is responsible for reporting data breach and information security incidents immediately to Infinity Works' ISMS Group (isms@infinityworks.com) - This should be done by completing a [Data Breach Incident Report Form](https://forms.gle/QjXKKgvQ1wZ4GLcV8).
...
The Incident Manager must also report the incident to the Accenture Security Operations Centre immediately on +1-202-728-0645 in accordance with the Accenture Code of Business Ethics, which can be found here.

Members of the ISMS Group will be automatically informed of the breach through email and Slack. The breach will be triaged, assigned owners, resolved, reported and escalated. The employees shown in the diagram below will form the core of the Investigation Office and will be assigned the following tasks:

| Steps	| Employee | Account Lead | Technical Director	| Head of Legal |	Operations Director | Data Protection  Officer|
|-------|----------|--------------|--------------------|-------------|-------------|------------|
| 1/ Report Breach	| Employee files breach report at: https://goo.gl/forms/VfHKbokfpRdGAc9f2 Forwards breach report email to their Account Lead and confirms receipt. | Receives breach report email from the reporting employee detailing the breach. Ensures Technical Director has been immediately notified about the breach.	| Receives email report detailing the breach and acknowledges receipt to the employee and their Account Lead.| Receives email report detailing the breach. | Receives email report detailing the breach.| Receives email report detailing the breach. |
...
| 3 Respond	| Works as part of the Investigation Office to construct, test and launch a fix. | Works as part of the Investigation Office to construct, test and launch a fix. Informs the client (as instructed by Head of Legal) | Coordinates the fix with the Investigation Office, sends out internal comms. Determines with Head of Legal if impact is wider than one client account. | 	Works within Investigation Office to understand legal and commercial impacts to the client(s) and company. Drafts external comms.| Escalation point - Takes over from the Technical Director only where comms are necessary across multiple accounts. Coordinates response via Head of Legal. | Escalation Point if breach is deemed to have any potential commercial or reputational impact. | 
| 4 Report	| Works with the other members of the Investigation Office to complete the Breach Report, detailing actions and mitigations. | Works with the other members of the Investigation Office to complete the Breach Report, detailing actions and mitigations. | Ensures breach is resolved and Breach Report has been completed and closed in agreement with the other members of the Investigation Office.	| Reports any data breach as required to the ICO. Adds incident to the MRM action log for discussion at the next MRM. | No further action at this point.  Incident to be discussed during the next MRM (ISO 27001 review section) | No further action at this point.  Incident to be discussed during the next MRM (ISO 27001 review section).

Table: Data Breach Roles & Responsibilities by Phase
