# Infinity Works Expenses Policy and Receipt Processing
...
Particular focus needs to be paid to the need to attach receipts which are VAT receipts i.e. ones where the VAT Registration Number can be found on the receipt itself.  This allows us to reclaim VAT effectively as a business.  
...
Depending on the type of expense you submit, the expense tool will automatically determine who will approve your expense.  This may be your Account Lead, Managing Consultant or a Board member. 

## How do I create a claim?
We use Kimble to claim for expenses, and have a user guide on the [infinitranet](https://sites.google.com/infinityworks.com/infinitranet/our-tools/kimble/expense-claims-faq) to answer common questions on entering and submitting expenses.
